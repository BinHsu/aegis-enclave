...
| Full production grade | Blows past "small application" and the 15h budget; reads as overengineered; risks signalling poor calibration. |
...
## Related ADRs
- ADR-0002 (15-hour budget that this calibration must fit inside)
